...
public class BlockAnalyzer extends Block implements ExtendedScreenHandlerFactory {
	...
	public static final Settings SETTINGS = Settings.copy(Blocks.STONE).strength(5.0f, 6.0f).nonOpaque();

	public static Identifier getId() {
		return Registries.BLOCK.getId(AoABlocks.ANALYZER);
	}
	...
	public BlockState getPlacementState(final ItemPlacementContext ctx) {
		return super.getPlacementState(ctx).with(BlockAnalyzer.FACING, ctx.getHorizontalPlayerFacing());
	}
